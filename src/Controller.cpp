	...
	*/
	...
	else if (type == WStype_TEXT)
	{
		...
		if(messageType == 0)
		{
			...
			{
				singleController[controllerIndex]->element[elementIndex]->data(num, (char*)String(nextNumber).c_str());
			}
		}
